...
*/
  static String buildBoundingBoxClause(
    ...
    final double leftTopLatitude = latLngBounds.northEast.lat.toDouble();
    final double leftTopLongitude = latLngBounds.southWest.lng.toDouble();
    final double rightBottomLatitude = latLngBounds.southWest.lat.toDouble();
    final double rightBottomLongitude = latLngBounds.northEast.lng.toDouble();
